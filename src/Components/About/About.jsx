...
const About = () => {
  return (
    <div className='bg-black text-white min-h-screen '>
        ...
        <div>
          <h1 className='text-6xl text-center mb-10 pt-10'>About us</h1>
        </div>
        ...
        <div>
          <h1 className='text-4xl mb-10 pt-10 text-center'>
            Features
          </h1>
        </div>
        <div className='flex justify-between mx-10'>
          <div className='border-2 border-cyan-200 shadow-lg hover:shadow-cyan-400 transition-all duration-300 p-5 rounded-lg m-5'>
            <h1 className='font-bold text-xl'>Project Showcasing</h1>
          ...
          <div className='border-2 border-cyan-200 shadow-lg hover:shadow-cyan-400 transition-all duration-300 p-5 rounded-lg m-5'>
            <h1 className='font-bold text-xl'>Interactive Code Postcards</h1>
          ...
          <div className='border-2 border-cyan-200 shadow-lg hover:shadow-cyan-400 transition-all duration-300 p-5 rounded-lg m-5'>
            <h1 className='font-bold text-xl'>Recruiter Connections</h1>
          ...
          <div className='border-2 border-cyan-200 shadow-lg hover:shadow-cyan-400 transition-all duration-300 p-5 rounded-lg m-5'>
            <h1 className='font-bold text-xl'>Collaborative Learning Community</h1>
